...
export default function Banner(): React.JSX.Element {
  const texts = ["Frontend Engineer", "UI Team Lead", "React JS Developer"];
      ...
      <div className="container mx-auto max-w-6xl">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Ravindra Pawar</span>
                    </p>
                  </div>
              ...
              <Image
                ...
                alt="Ravindra Pawar - Frontend Engineer"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              ...
              <p className="text-md text-white/80">
                Because great user experiences begin with thoughtful engineering.
              </p>
            </div>
          </div>
        </div>
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Currently, I&apos;m a UI, Team Lead at</span>
            <span className="flex items-center gap-2">
              {/* <Image src="/assets/affinity.png" alt="Affinity Global" height={20} className="w-5 h-5" style={{ width: "auto", height: "auto" }} /> */}
              <span className="text-blue-400 font-semibold">Affinity,</span>
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            I'm a passionate Frontend Engineer focused on building enterprise-grade web applications using React, JavaScript, and modern UI technologies.

            Throughout my career, I've designed and developed interactive dashboards, advertising platforms, analytics tools, and business applications that serve thousands of users. I believe clean architecture, reusable components, and intuitive user experiences are the foundation of every successful product.

            When I'm not coding, I enjoy exploring new technologies, contributing to personal projects, and building digital products that solve real-world problems.
          </p>
        </div>
      </div>
    </section>
